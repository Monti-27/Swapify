...
export function PriceChart() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-white to-gray-50 dark:from-[#1a1a1a] dark:to-[#141414] rounded-2xl p-5 border border-gray-200 dark:border-white/5 h-full"
    >
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Chart</h3>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-3xl font-bold text-gray-900 dark:text-white">$38,252.02</p>
        </div>

        <div className="flex items-center gap-1 bg-gray-100 dark:bg-[#0a0a0a] rounded-full p-1">
        ...
        <ResponsiveContainer width="100%" height={280} minWidth={300}>
          <AreaChart data={chartData}>
            ...
            <XAxis
              ...
              axisLine={false}
              tickLine={false}
              tick={{ fill: isDark ? "#666" : "#9ca3af", fontSize: 11 }}
              dy={10}
            />
            <YAxis
              axisLine={false}
